...
var Peer = /** @class */ (function () {
    function Peer(address, port) {
        ...
        this.controller = new bnrtc2_client_1.Bnrtc2Controller("127.0.0.1", this.port);
    }
    Peer.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.controller.bindAddress(this.address)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.dchat.onMessage(DCHAT_DPORT, function (address, dport, data) {
                                _this.receiveCnt++;
                                return true;
                            })];
                    case 2:
    ...
    Peer.prototype.send = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pererAddress = peers[Math.floor(Math.random() * num)].address;
